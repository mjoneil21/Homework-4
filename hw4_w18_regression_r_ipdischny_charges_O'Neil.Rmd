...
MADtrain <- MADtrain1 + MADtrain2 + MADtrain3
Madtest <- MADtest1 + MADtest2 + MADtest3
MAD <- data.frame(MADtrain, Madtest)
MAD
```
...
```{r}
ggplot() + geom_point(data = Madtest, aes(x=Madtest$MADtest1)
```
